...
if (defined('G5_IS_ADMIN')) {
    ...
    echo '<link rel="stylesheet" href="'.run_replace('head_css_url', G5_CSS_URL.'/animate.css?ver='.G5_CSS_VER, G5_URL).'">'.PHP_EOL;
    echo '<link rel="stylesheet" href="'.run_replace('head_css_url', G5_CSS_URL.'/media.css?ver='.G5_CSS_VER, G5_URL).'">'.PHP_EOL;
}
?>
<!--[if lte IE 8]>
