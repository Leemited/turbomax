...
<section>
    ...
    <fieldset id="fsendmailtest">
        ...
        <label for="email" style="font-size: 18px;letter-spacing: -1px">받는 메일주소<strong class="sound_only"> 필수</strong></label>
        <input type="text" name="email" value="<?php echo $member['mb_email'] ?>" id="email" style="font-size: 18px;letter-spacing: -1px;padding:10px 15px"required class="required email frm_input" size="80">
