...
<header id="hd">
    ...
    <div id="hd_top">
       ...
       <div id="logo"><a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>">turbomax</a></div>
        ...
        <div id="tnb">
            <ul>
                ...
                <li class="tnb_li"><button type="button" class="tnb_mb_btn" style="background-color: #333;border-radius: 30px;font-size: 14px">관리자<span class="./img/btn_gnb.png">메뉴열기</span></button>
