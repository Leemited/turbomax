...
<?php } ?>
	...
	<div id="register_form" class="form_01">   
	    <div class="register_form_inner">
            ...
            <p class="sub_tit">터보맥스 회원이 되시면 다양한 서비스 이용이 가능합니다.</p>
	        <ul>
	            <li>
	                <label for="reg_mb_id">
	            ...
	            <li class="">
	                <label for="reg_mb_password"><strong class="sound_only">필수</strong></label>
	            ...
	            <li style="margin-bottom: 0px">
	                <label for="reg_mb_password_re"><strong class="sound_only">필수</strong></label>
	    ...
	    <div class="tbl_frm01 tbl_wrap register_form_inner">
            <p style="border-top: 1px solid #c1c1c1;width: 380px"></p>
	        <ul style="padding-bottom: 0px">
	            <li>
	                <label for="reg_mb_name"><strong class="sound_only">필수</strong></label>
	            ...
	            <li>
	                <label for="reg_mb_email"><strong class="sound_only">필수</strong>
...
gif, jpg, png파일만 가능하며 용량 <?php echo number_format($config['cf_member_icon_size']) ?>바이트 이하만 등록됩니다.</span>
	            ...
	            <li class="chk_box" style="margin-bottom: 6.5px">
	            ...
	            <li class="is_captcha_use" style="margin-top: 24px">
	                자동등록방지
	                <?php echo captcha_html(); ?>
	            </li>
	        </ul>
	    </div>
        <div class="btn_confirm" style="padding-top: 40px;padding-bottom: 110px">
