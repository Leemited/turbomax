...
<div id="bo_gall" style="width:<?php echo $width; ?>">
    <div id="container_a">
    <section class="com_w">
        <h1 class="title">홍보자료</h1>
        <p class="sub_tit_1">브로슈어는 기업의 비전과 터보블로워의 핵심기술 및 사양을 담아<br>
        터보맥스의 정보를 한 번에 파악할수 있도록 제작되었습니다.</p>
    </section>
            ...
            <div class="gall_box">
                ...
                <div class="gall_con">
                    <div class="gall_img" style="<?php if ($board['bo_gallery_height'] > 0) echo 'height:'.$board['bo_gallery_height'].'px;max-height:'.$board['bo_gallery_height'].'px'; ?>">
                        <a href="<?php echo $list[$i]['file'][0]['href']; ?>">
                        <?php
                    ...
                    <div class="gall_text_href">
                        ...
                        <?php } ?>
                            ...
                            <?php if ($list[$i]['file'][0]['file']) { ?>
                                ...
                                <a href="<?php echo $list[$i]['file'][0]['href']; ?>" class="bo_tit promotion_title_icon"><img src="<?php echo $board_skin_url ?>/img/download.png"></a>

                            <?php } ?>

                        <a href="<?php echo $list[$i]['file'][0]['href']; ?>" class="bo_tit">
