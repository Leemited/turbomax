...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <header>
        ...
        <hr size="2" color="#28448D" class="hr_margin">
        <h2 id="bo_v_title">
            ...
            <span class="bo_v_tit">
                ...
                <div class="notice_num"><?php echo $_GET['num'];?></div>
              <div class="notice_subject"> <?php echo cut_str(get_text($view['wr_subject']), 70); // 글제목 출력? ?></div>

                <div class="notice_datetime"><?php echo $view['datetime'] ?></div>
            </span>
        </h2>
    </header>
    ...
    <hr size="2" color="#28448D" class="hr_margin">
    <ul class="prev_list">
        <?php if ($next_href) {?> <li><a href="<?php echo $next_href ?>&num=<?php echo $_GET['num']-1;?>" class="btn_b01 btn list_1" title="이전">이전</a></li> <?php }?>

    <li><a href="<?php echo $list_href ?>" class="btn_b01 btn list_0" title="목록">목록</a></li>
    </ul>
