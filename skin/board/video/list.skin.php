...
<div id="bo_gall" style="width:<?php echo $width; ?>">
    ...
    <section class="com_w">
        ...
        <p class="sub_tit_1">터보맥스의 생생한 이야기를 들려드립니다.</p>
    </section>
    <div class="main_video">
        <iframe width="900" height="600" src="https://www.youtube.com/embed/aM4r-JncYsg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <div class="main_video_text">
        <p>TurboMAX_공기베어링_기술소개_국문_2018</p>
        <a href="https://www.youtube.com/channel/UC2-V4Lkqc6td7g0P-2aiDkw/featured"><img src="<?php echo $board_skin_url ?>/img/youtube_icon.png"> TurboMAX 유튜브 채널 바로가기 <img src="<?php echo $board_skin_url ?>/img/right_arrow.png"> </a>
    </div>
    <?php if ($is_category) { ?>
    <nav id="bo_cate">
