...
<section id="bo_w" xmlns="http://www.w3.org/1999/html">
    <div id="container_a">
    <section class="com_w">
    ...
    <!-- 게시물 작성/수정 시작 { -->
    <div name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:<?php echo $width; ?>">
