...
<div id="bo_gall" style="width:<?php echo $width; ?>">
    <div id="container_a">
    <section class="com_w">
        <h1 class="title">보도자료</h1>
        <p class="sub_tit_1">언론에 소개된 터보맥스의 최신소식을 전해드립니다.</p>
    </section>
                ...
                <div class="gall_con">
                    ...
                    <div class="gall_text_href">
                        ...
                        <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">
                            ...
                            <div class="news_main <?php if($i==0){echo latest_main;}?>">
                                <div class="main_news <?php if($i==0){echo latest_news;}?>">
                            <?php echo $list[$i]['subject'];?>
                            </div>
                            <div class="main_news_text">
                            <?php if($i==0){echo utf8_strcut(strip_tags($list[0]['wr_content']), 180, '..');} ?>
                            </div>
                                <div class="gall_info">
                         ...
                         <span class="bo_cnt"><?php echo utf8_strcut(strip_tags($list[$i]['wr_content']), 180, '..'); ?></span>
                    </div>
